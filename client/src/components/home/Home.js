				...
				>
					<Box py={1} px={2}>
						<Typography
							...
							sx={{ color: "white" }}
						>
							Jau pats laikas TAVO mokyklai išbandyti edukacinių - orientacinių
							varžybų kūrimo ir žaidimo platformą. Nesnausk, užsisakyk jau
							šiandien!
						</Typography>
					</Box>
				</CardContent>
				...
				>
					<Box py={5} px={2}>
						...
						<Typography
							...
							sx={{ color: "white" }}
						>
							Prenumeratą įsigyti galite susisiekę su mumis el. paštu:
							pvp.projektas@pvp.pvp arba telefonu: +37061111111
						</Typography>
					</Box>
				</CardContent>
			</Card>
